                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><img src="{{ asset($about->image) }}" width="100"
                                    height="50"></td>
                                <td class="text-center">{{ $about->translate('az')->title }}</td>
                                <td class="text-center">{{ $about->translate('az')->content }}</td>
                                <td class="text-center">{{ $about->translate('az')->alt }}</td>
                                <td>{{ date('d.m.Y H:i:s',strtotime($about->created_at))}}</td>
                                <td class="text-center">
                                    <a class="btn btn-primary"
                                        href={{ route('backend.about.edit',$about->id) }}>
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a class="btn btn-danger"
                                        href="{{ route('backend.about.destroy',$about->id) }}">
