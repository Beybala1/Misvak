        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.about.update',$about->id) }}" class="needs-validation"
                                  novalidate
                                ...
                                <div class="card-body">
                                    <div class="col-12">
                                        <div
                                            ...
                                            <h4 class="mb-sm-0">@lang('backend.new') @lang('backend.about')</h4>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label>@lang('backend.image'):</label>
                                        <div>
                                            <img width="100%" height="auto" src="{{ asset($about->image) }}">
                                        </div>
                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="content[{{ $lan->code }}]" type="text"
                                                                  class="form-control" required=""
                                                                  rows="6">{{ $about->translate($lan->code)->content }}</textarea>
                                                        <div class="valid-feedback">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="alt[{{ $lan->code }}]" type="text"
                                                                value="{{ $about->translate($lan->code)->alt }}"
                                                                class="form-control" 
                                                                data-parsley-minlength="6"
