        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.contact-info.update',$contactInfo->id) }}" class="needs-validation"novalidate method="post">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="col-12">
                                    ...
                                    <div class="tab-content p-3 text-muted">
                                        <label>@lang('backend.content') <span
                                            ...
                                            rows="7"
                                            placeholder="@lang('backend.content')">{{ $contactInfo->content }}</textarea>
