                    ...
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.products.update',$product->id) }}" class="needs-validation"
                              ...
                              <div class="card-body">
                                <div class="col-12">
                                    ...
                                    <h4 class="mb-sm-0">@lang('backend.new') @lang('backend.products')</h4>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label>@lang('backend.image'):</label>
                                <div>
                                    <img width="100%" height="auto" src="{{ asset($product->image) }}">
                                </div>
                            </div>
                            ...
                            <div class="tab-content p-3 text-muted">
                                ...
                                <div class="mb-3">
                                    <label>@lang('backend.category') <span class="text-danger">*</span></label>
                                    <select name="category_id" class="form-control" required>
                                        <option value="">@lang('backend.chooseCategory')</option>
                                    ...
                                    <div class="valid-feedback">
                                        @lang('backend.category') @lang('messages.is-correct')
                                    </div>
                                    <div class="invalid-feedback">
                                        @lang('backend.category') @lang('messages.not-correct')
                                    </div>
                                </div>
                                @foreach(active_langs() as $lan)
                                <div class="tab-pane @if($loop->first) active show @endif"
                                   ...
                                   <div class="form-group row">
                                    <div class="mb-3">
                                        ...
                                        value="{{ $product->translate($lan->code)->title }}"
                                    ...
                                    <div class="mb-3">
                                        <label>@lang('backend.content') <span
                                            ...
                                            <textarea name="content[{{ $lan->code }}]" type="text"
                                              class="form-control" required=""
                                              rows="6">{{ $product->translate($lan->code)->content }}</textarea>
                                              <div class="valid-feedback">
