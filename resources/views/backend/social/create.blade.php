        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.social.store') }}" class="needs-validation" novalidate
                                  method="post">
                                @csrf
                                <div class="card-body">
                                    <div class="col-12">
                                        <div
                                            ...
                                            <h4 class="mb-sm-0">@lang('backend.social')</h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-content p-3 text-muted">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="icon" class="form-control" required placeholder="@lang('backend.icon')">
